...
#define MT7531_PCS_STATUS_2(p)		MT7531_SGMII_REG(p, 0x10)
#define  MT7531_SGMII_PCS_FAULT		BIT(23)
...
#define MT7531_SGMII_TX_FAULT_LATCH		BIT(11)
#define MT7531_SGMII_RX_FAULT_LATCH		BIT(10)
